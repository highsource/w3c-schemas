...
var mappings = [XMLDSig_Core_1_1, XMLDSig_1_1];
module.exports = {
	...
	"Example" : function(test) {
		var context =  new Jsonix.Context([XMLDSig_Core_1_1, XMLDSig_1_1]);
		var unmarshaller = context.createUnmarshaller();
		unmarshaller.unmarshalFile("tests/XMLDSig/1.1/signature-example-rsa.xml", function(result) {
